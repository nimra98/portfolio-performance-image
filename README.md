...
<img width="1881" height="1096" alt="grafik" src="https://github.com/user-attachments/assets/85fad603-97cd-4137-97ee-b2f5e866c6ce" />
...
**Note for existing users:** The environment variables `USER_LANGUAGE`, `USER_COUNTRY`, and `USER_TIMEZONE` have been added to give you more control over the localization of the application. If you don't set these variables in your `docker-compose.yml` file, they will default to the values in the table below, which should not cause any breaking changes to your existing setup.
